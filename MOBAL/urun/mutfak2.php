...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="İndigo Masa Seti" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/mutfak2_urun.jpg" width="450" height="250">
        <br></br>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    ...
    <tr>
      <td>Genişlik:	206.00 cm</td>
      <td>Genişlik:	45.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Yükseklik: 77.00 cm</td>
