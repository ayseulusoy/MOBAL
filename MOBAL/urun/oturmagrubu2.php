...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Pier Salon Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/oturmagrubu2_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        ...
        -Pier ürünümüzün berjeri; son derece estetik ve farklı tasarımı sunmaktadır.
        </p>
        <p>
        Fiyat: 29.620,00 TL
        </p>
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="29.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    <tr>
      <td>Derinlik:	95.00 cm</td>
      <td>Derinlik:	95.00 cm</td>
      <td>Derinlik:	88.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	232.00 cm</td>
      <td>Genişlik:	194.50 cm</td>
      <td>Genişlik:	78.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 92.00 cm</td>
      <td>Yükseklik: 92.00 cm</td>
      <td>Yükseklik: 107.50 cm</td>
    </tr>
  </tbody>
</table>
</div>
