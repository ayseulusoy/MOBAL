...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Karat Yemek Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/yemekodasi1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Avangart tarzı, fildişi rengi, dekotratif uygulamaları, modern tasarımı ve şık görüntüsü ile evinizin havasını değiştirecekbir tasarım. <br>
        -İnsan sağlığına dost, kanserojen madde içermeyen E1 standartlarında malzemeler kullanılmaktadır. <br>
        -Sabit ve açılır olmak üzere iki farklı masa alternatifi bulunmakta olup kitabeli masa özelliği ile kapalıyken 6 kişilik açıkken 8 kişilik olabilmektedir. Sabit masa 8 kişiliktir.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="16.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      <th scope="col">Yemek Masası </th>
      <th scope="col">Sandalye</th>
      <th scope="col">Konsol</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	100.00 cm</td>
      <td>Derinlik:	47.00 cm</td>
      <td>Derinlik:	49.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	200.00 cm</td>
      <td>Genişlik:	50.00 cm</td>
      <td>Genişlik:	186.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 78.00 cm</td>
      <td>Yükseklik: 103.00 cm</td>
      <td>Yükseklik: 84.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
