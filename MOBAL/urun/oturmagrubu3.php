...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Mikado Deluxe Takım" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/oturmagrubu3_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        ...
        -Mikado ürünümüzün berjeri; son derece estetik ve farklı tasarımı sunmaktadır.
        </p>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      ...
      <th scope="col">İkili Kanepe</th>
      <th scope="col">Berjer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	98.00 cm</td>
      <td>Derinlik:	98.00 cm</td>
      <td>Derinlik:	86.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	223.00 cm</td>
      <td>Genişlik:	173.00 cm</td>
