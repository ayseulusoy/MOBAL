...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Lena Genç Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/gencvebebekodasi2_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Modern bir tasarıma sahip olup, hem renk hem de kullanılan malzemeleriyle oldukça modern bir tasarıma sahiptir.<br>
        ...
        -Farklı tarzı ve modern tasarımı ile yaşam alanlarınıza renk katarken, ürün kapaklarındaki çerceve etkisi, zarif görünümü, deri kulp uygulaması ile zenginleştirilmiştir.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="19.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      ...
      <th scope="col">Çalışma Masası</th>
      <th scope="col">Şifonyer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	59.00 cm</td>
      <td>Derinlik:	63.00 cm</td>
      <td>Derinlik:	45.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	179.00 cm</td>
      <td>Genişlik:	119.00 cm</td>
      <td>Genişlik:	62.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 221.00 cm</td>
      <td>Yükseklik: 163.00 cm</td>
