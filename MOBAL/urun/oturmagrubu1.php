...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Prado Salon Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/oturmagrubu1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        ...
        -Prado ürünümüzün berjeri; son derece estetik ve farklı tasarımı sunmaktadır.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="30.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      <th scope="col">Üçlü Koltuk </th>
      <th scope="col">Üçlü Kanepe</th>
      <th scope="col">Berjer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	94.00 cm</td>
      <td>Derinlik:	92.00 cm</td>
      <td>Derinlik:	90.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	235.00 cm</td>
      <td>Genişlik:	232.00 cm</td>
      <td>Genişlik:	86.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 81.00 cm</td>
      <td>Yükseklik: 94.00 cm</td>
      <td>Yükseklik: 100.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
