...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Gallery Genç Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/gencvebebekodasi1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Hem renk hem de kullanılan malzemeleriyle oldukça modern bir tasarıma sahiptir.<br>
        ...
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="20.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    <tr>
      <td>Derinlik:	62.00 cm</td>
      <td>Derinlik:	65.00 cm</td>
      <td>Derinlik:	46.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	134.00 cm</td>
      <td>Genişlik:	123.00 cm</td>
      <td>Genişlik:	59.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 201.00 cm</td>
      <td>Yükseklik: 146.00 cm</td>
      <td>Yükseklik: 108.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
