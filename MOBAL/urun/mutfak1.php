...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Forest Banklı Mutfak Masa Seti" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/mutfak1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        ...
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="12.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      ...
      <th scope="col">Sırtsız Bank</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	75.00 cm</td>
      <td>Derinlik:	42.00 cm</td>
      <td>Derinlik:	40.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	130.00 cm</td>
      <td>Genişlik:	45.00 cm</td>
      <td>Genişlik:	95.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 78.00 cm</td>
      <td>Yükseklik: 47.00 cm</td>
      <td>Yükseklik: 45.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
