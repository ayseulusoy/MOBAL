...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Gusto Yatak Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/yatakodasi1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Klasik tarzı fildişi rengi ile oldukça şık bir tasarıma sahiptir. <br>
        -İnsan sağlığına dost, kanserojen madde içermeyen E1 standartlarında malzemeler kullanılmaktadır. <br>
        -Detay uygulamaları, kabartmalı desen uygulamaları ve lukens ayakları, farklı tasarıma sahip komodin aydınlatması ve şık detayları ile klasik tarzın çizgilerini yansıtmaktadır.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="35.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    ...
    <tr>
      <td>Genişlik:	282.00 cm</td>
      <td>Genişlik:	55.00 cm</td>
      <td>Genişlik:	119.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 217.00 cm</td>
      <td>Yükseklik: 63.00 cm</td>
      <td>Yükseklik: 89.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
