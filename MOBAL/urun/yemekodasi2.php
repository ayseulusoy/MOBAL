...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="İndigo Yemek Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/yemekodasi2_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Son derece şık ve farklı bir tasarıma sahip olup, hem renk uygulamaları hem de kullanılan malzemeleriyle üst düzey modern bir tasarıma sahiptir. <br>
        -İnsan sağlığına dost, kanserojen madde içermeyen E1 standartlarında malzemeler kullanılmaktadır. <br>
        -Yemek Masası Sabit tarzda tasarlanmış olup, 8 kişilik olabilmektedir.
        </p>
