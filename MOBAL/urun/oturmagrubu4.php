...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Lauren Köşe Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/oturmagrubu4_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Ürünümüzün sırt kısmında yerlan kapitone uygulaması yüksek ayak yapısı ile tasarımı farklılaştırılmıştır. <br>
        -Lauren ürünümüzün berjeri; son derece estetik ve farklı tasarımı sunmaktadır.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="21.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      <th scope="col">Köşe Koltuk </th>
      <th scope="col">Tekli Koltuk</th>
      <th scope="col">Berjer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	264.00 cm</td>
      <td>Derinlik:	90.00 cm</td>
      <td>Derinlik:	92.50 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	344.00 cm</td>
      <td>Genişlik:	79.00 cm</td>
      <td>Genişlik:	67.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 71.00 cm</td>
      <td>Yükseklik: 94.00 cm</td>
      <td>Yükseklik: 89.50 cm</td>
    </tr>
  </tbody>
</table>
</div>
