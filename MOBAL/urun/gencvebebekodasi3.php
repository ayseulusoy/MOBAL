...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Gold Bebek Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/gencvebebekodasi3_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Gold Compact Beşik opak beyaz renkte tasarlanmış olup, görsel açıdan oldukça şık bir üründür.<br>
        -İnsan sağlığına dost, kanserojen madde içermeyen E1 standartlarında malzemeler kullanılmaktadır. Bu malzemeler kullanım açısından çizilme, sürtünme ve yanmaya dayanıklı olup, kolay temizlenme özelliğine sahiptir.<br>
        -Gold Bebek Odası Takımı kullanılan altın renkli dekoratif işlemeleri, zarif görünümü, kulp üzerinde yer alan püskül uygulaması ve yerden yüksek lükens ayakları ile görsel açıdan ön plana çıkmaktadır.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="7.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      <th scope="col">Dolap </th>
      <th scope="col">Bebek Karyolası</th>
      <th scope="col">Şifonyer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Derinlik:	65.00 cm</td>
      <td>Derinlik:	85.00 cm</td>
      <td>Derinlik:	48.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	150.00 cm</td>
      <td>Genişlik:	195.00 cm</td>
      <td>Genişlik:	62.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 207.00 cm</td>
      <td>Yükseklik: 105.00 cm</td>
      <td>Yükseklik: 110.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
