...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Lena Kitaplık" readonly></h1>
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/aksesuar1_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        ...
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="2.000,00" readonly> ₺</h2>
