...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Vals Koltuk Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/oturmagrubu5_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Modern tarzı, P kol yapısı ve kol bölümlerinde yer alan  düğme ve çektirme uygulamaları ile modern ve şık bir tasarımın ürünüdür. <br>
        -Üçlü ünitelerde yer alan yatak mekanizması sayesinde, kolayca yatak olabilme özelliğine sahiptir.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="25.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    <tr>
      ...
      <td>Derinlik:	100.00 cm</td>
      <td>Derinlik:	93.00 cm</td>
      
      
    </tr>
    <tr>
      <td>Genişlik:	222.00 cm</td>
      <td>Genişlik:	168.00 cm</td>
      <td>Genişlik:	81.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 79.00 cm</td>
      <td>Yükseklik: 79.00 cm</td>
      <td>Yükseklik: 98.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
