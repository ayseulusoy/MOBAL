...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Elite Yatak Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/yatakodasi2_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Elite Yatak Odası Takımı alışılmışın dışında bir çizğiye sahip olup, modern ve klasik çizgilerin birleştiği avangart tasarımı ile üst düzey tasarıma sahip bir üründür. <br>
        -Elite Yatak Odası takımı, görsel zenginliğin yanında işlevselliği ve fonksiyonu da beraberinde sunan bir takımdır. <br>
        -Birbirini tamamlayan altın renk uygulamaları, farklı tasarıma sahip ayak yapısı, ünite kapakları üzerinde yer alan bronz renkli aynası ve şık kulpdetayları ile görsel açıdan zenginleştirilmiştir.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="33.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  <thead>
    <tr>
      ...
      <th scope="col">Komodin</th>
      <th scope="col">Makyaj Masası</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td>Genişlik:	270.00 cm</td>
      <td>Genişlik:	63.00 cm</td>
      <td>Genişlik:	112.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 215.00 cm</td>
      <td>Yükseklik: 55.00 cm</td>
      <td>Yükseklik: 87.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
