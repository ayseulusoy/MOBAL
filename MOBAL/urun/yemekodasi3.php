...
<div class="row row-cols-2">
    ...
    <form method="POST" action="../sepeteekle.php">
        <h1 ><input type="text" class="bg-light text-dark" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Rosalina Yemek Odası Takımı" readonly></h1>
        
        <div class="img-zoom-container">
        <img id="myimage" src="../resimler/yemekodasi3_urun.jpg" width="450" height="250">
        <br></br>
    ...
    <div class="col bg-light text-dark rounder">
        <p>
        Genel Bilgiler;<br>
        -Rosalina Yemek Odası Takımı opak beyaz renkte tasarlanmış olup, sandalyelerde kullanılan pudra tonları ile görsel açıdan şık bir görünüm kazandırılmıştır. <br>
        -İnsan sağlığına dost, kanserojen madde içermeyen E1 standartlarında malzemeler kullanılmaktadır. <br>
        -Yerden yüksek ayak yapısı ile hem modern bir görünüm kazanmakta hem de temizlik konusunda kolaylık sağlamaktadır.
        </p>
        
        <h2 class="float-right text-dark"><input type="text" class="bg-light text-dark mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="15.620,00" readonly> ₺</h2>
...
<table class="table table-bordered border-dark mt-3 bg-light ">
  ...
  <tbody>
    ...
    <tr>
      <td>Genişlik:	204.00 cm</td>
      <td>Genişlik:	50.00 cm</td>
      <td>Genişlik:	199.00 cm</td>
      
    </tr>
    <tr>
      <td>Yükseklik: 76.00 cm</td>
      <td>Yükseklik: 103.00 cm</td>
      <td>Yükseklik: 80.00 cm</td>
    </tr>
  </tbody>
</table>
</div>
